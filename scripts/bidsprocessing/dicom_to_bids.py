...
parser.add_argument('-i', default='/projects/b1108/studies/transitions2/data/raw/neuroimaging/dicoms/uncompressed')
parser.add_argument('-o', default='/projects/b1108/studies/transitions2/data/raw/neuroimaging/bids')
